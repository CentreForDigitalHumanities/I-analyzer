...
def test_tag_filter(mock_corpus, index_tag_mock_corpus, auth_user_tag, tagged_documents):
...
def test_search_with_tag(mock_corpus, index_tag_mock_corpus, auth_user_tag, tagged_documents):
...
def test_search_multiple_tags(mock_corpus, index_tag_mock_corpus, multiple_tags):
