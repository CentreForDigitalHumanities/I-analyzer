    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('languages', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=8, validators=[addcorpus.validators.validate_language_code]), help_text='languages used in the content of the corpus (from most to least frequent)', size=None)),
